...
const GALLERY = [
  ...
  'https://images.unsplash.com/photo-1607082348837-13d8a85fe5d2?w=900&q=85',
];
...
export default function HeatTransferPrint() {
  return (
    <div className="min-h-screen flex flex-col bg-background"><Header /><main className="flex-1">
      ...
      <WorkGallery title="Галерея робіт" subtitle="Приклади термопереносу — логотипи, написи, номери на одязі." images={GALLERY} />
