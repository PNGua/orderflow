    ...
    groups: [
      {
        ...
        link: '/catalog?cat=dtf',
        items: [
          { label: 'ДТФ плівка преміум', link: '/catalog?cat=dtf&q=преміум' },
          { label: 'ДТФ плівка золота фольга', link: '/catalog?cat=dtf&q=золота фольга', highlight: true },
          { label: 'ДТФ плівка золото глітер', link: '/catalog?cat=dtf&q=золото глітер' },
          { label: 'ДТФ плівка срібло глітер', link: '/catalog?cat=dtf&q=срібло глітер' },
          { label: 'ДТФ плівка хамелеон/глітер', link: '/catalog?cat=dtf&q=хамелеон' },
          { label: 'ДТФ плівка люмінісцентна', link: '/catalog?cat=dtf&q=люмінісцентна' },
          { label: 'ДТФ плівка рефлектив', link: '/catalog?cat=dtf&q=рефлектив' },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        link: '/catalog?cat=uv_dtf',
        items: [
          { label: 'Преміум УФ ДТФ плівка', link: '/catalog?cat=uv_dtf&q=Преміум' },
          { label: 'Золота УФ ДТФ плівка', link: '/catalog?cat=uv_dtf&q=Золота' },
          { label: 'Срібна УФ ДТФ плівка', link: '/catalog?cat=uv_dtf&q=Срібна' },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        link: '/catalog?cat=samples',
        items: [
          { label: 'Папка з взірцями DTF та UV DTF', link: '/catalog?cat=samples&q=Папка' },
          { label: 'Взірці УФ ДТФ друку та плівки', link: '/catalog?cat=samples&q=УФ ДТФ' },
          { label: 'Взірці DTF друку та плівки', link: '/catalog?cat=samples&q=Взірці DTF' },
        ],
      },
    ],
  },
